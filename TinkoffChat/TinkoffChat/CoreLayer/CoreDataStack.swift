...
class CoreDataStack {
    ...
    static func insertProfile(in context: NSManagedObjectContext) {
        NSEntityDescription.insertNewObject(forEntityName: "Profile", into: context) //as? Profile
    }
    
//    static func findProfile(in context: NSManagedObjectContext) {
//        var Profile?
...
//        }
//        
//        guard let fetchRequest = Profile.etchRequestProfile(model: model) else {
//            return nil
//        }
//        
//        do {
